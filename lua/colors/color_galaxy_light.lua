...
local Usual = {
  MarkdownHighlights = {
    ...
    markdownHeadingDelimiter = { fg = c.green_two },
  ...
  LspRelated = {
    ...
    LspDiagnosticsSignError = { bg = back, fg = c.red_four },
    LspDiagnosticsSignHint = { bg = back, fg = c.blue_two },
    LspDiagnosticsSignWarning = { bg = back, fg = c.orange_one },
    LspDiagnosticsSignInformation = { bg = back, fg = c.yellow_one },
    DiagnosticsDefaultError = { bg = back, fg = c.red_four },
    DiagnosticsDefaultHint = { bg = back, fg = c.blue_two },
    DiagnosticsDefaultWarning = { bg = back, fg = c.orange_one },
    DiagnosticsDefaultInformation = { bg = back, fg = c.yellow_one },
    DiagnosticsSignError = { bg = back, fg = c.red_four },
    DiagnosticsSignHint = { bg = back, fg = c.blue_two },
    DiagnosticsSignWarning = { bg = back, fg = c.orange_one },
    DiagnosticsSignInformation = { bg = back, fg = c.yellow_one },
